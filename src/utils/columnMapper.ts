...
export const COLUMN_MAPPINGS = {
  ...
  category: ['category', 'categoria', 'categorie', 'kategorie', 'merchant category', 'transaction category', 'expense category', 'spending category'],
...
export function detectExtraFields(headers: string[]): { [key: string]: number } {
  ...
  if (categoryIndex !== -1) extraFields.bankCategory = categoryIndex;
